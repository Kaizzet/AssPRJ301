...
<html lang="vi">
    ...
    <body>
        ...
        <div class="sub-header">
            ...
            <button class="add-btn" onclick="openModal(false)">Add Product</button> <!-- Thêm nút này -->       
        </div>
    ...
    if (!name || !description || !price || !material || !categoryId || !imageUrl || !amount) {
    ...
    formData.append("description", description); // ✅ Gửi description
